...
# Booking.com - Web - Lesson 3 - Page Object Model - Typescript
...
```sh
git clone https://github.com/Manual-To-Automation-Booking-Amsterdam/Web-Lesson-3-POM-TS.git
```

Move into the directory:

```sh
cd Web-Lesson-3-POM-TS
```
